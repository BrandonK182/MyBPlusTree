 ...
 * *******************************************/
template <typename T>
void BTree<T>::print_tree(int level, std::ostream& outs) const {
    if (child_count > 0)
    {
...
void BTree<T>::insert(const T& entry) {
    ...
    {
        BTree<T>* copied_tree = new BTree<T>;
...
/************************************************
 * copy_tree(const BTree<T>& other)
 * function that copies the content of the other
 * btree and calls the same function for it's children
 * parameter: Btree other - tree to copy
 * return: none
 * *******************************************/
template <typename T>
...
void BTree<T>::rotate_left(int i) {
    if (0 < i && i <child_count && subset[i]->data_count > MINIMUM)
    {
        ...
        BTree<T>* subtree = subset[i] -> subset[0];
...
void BTree<T>::rotate_right(int i) {
    if (i<child_count - 1 && subset[i]->data_count > MINIMUM)
    {
        ...
        BTree<T>* subtree = subset[i]->subset[subset[i]->data_count];
...
template <typename T>
void BTree<T>::test_sample_print()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_copy_constructor()
{
    std::cout << "TESTING COPY CONSTRUCTOR" << std::endl;
    BTree<T> aTree;
    aTree.construct_sample();
    BTree<T> newTree(aTree);
...
template <typename T>
void BTree<T>::test_sample_destructor()
{
...
template <typename T>
void BTree<T>::test_sample_assignment()
{
...
template <typename T>
void BTree<T>::test_sample_insert()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_remove()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_clear()
{
...
template <typename T>
void BTree<T>::test_sample_contains()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_maximal()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_index_of_maximal()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_ordered_insert()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_first_ge()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_attach_item()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_insert_item()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_detach_item()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_delete_item()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_merge()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_split()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_copy_array()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_print_array()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_is_gt()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_sample_is_le()
{
    construct_sample();
...
template <typename T>
void BTree<T>::test_rotate_right()
{
    //      150
    // 100
    //      empty
